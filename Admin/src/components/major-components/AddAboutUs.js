...
export const AddAboutUs = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        await axiosInstance.post('/api/v1/about/addaboutus', { data: aboutData, heading: aboutHeading })
            .then((res) => {
                dispatch(selectProgressBarState(false))
                alert.show('Successfully Updated About Us')
                getAboutUs()
            })
            .catch((err) => {
                dispatch(selectProgressBarState(false))
                    ...
                    <div className=" mt-24  ml-[20%]  w-[78%]">
                        <div className="py-2 bg-gray-50">
                            <div className=' bg-white rounded-lg  shadow-lg'>
                                ...
                                <div className="p-3">
                                    <h2 className='font-semibold py-2 text-gray-800 text-lg'>About Us Heading</h2>
                                    <CKEditor
                                    ...
                                    />
                                    <h2 className='font-semibold py-2 text-gray-800 text-lg'>About Us Data</h2>
                                    <CKEditor
                                        editor={ClassicEditor}
                                        data={data}
                                        config={{
